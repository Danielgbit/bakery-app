...
function Discover() {
  ...
  return (
    <section className="bg-primary py-40" id="historia">
      <div className="max-w-7xl mx-auto px-4 flex flex-col md:flex-row items-center gap-12">
        ...
        <div className="md:w-1/2">
          <Image
            ...
            width={300}
            height={300}
            className="w-full object-cover h-100 rounded-4xl shadow-md"
            src={image}
          />
        </div>

        {/* Texto */}
        <div className="md:w-1/2 h-100 flex flex-col justify-start">
          <div className="w-[90%]">
